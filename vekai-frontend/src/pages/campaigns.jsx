...
import { LEADERBOARD_ITEMS, MERCH_ITEMS } from '../data/siteData';
      ...
      <div className="space-y-10 p-8">
        <section className="mx-auto max-w-[1200px] rounded-4xl border border-white/10 bg-cyberPanel/95 p-8 shadow-glow">
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
            ...
            <Link href="/explore" className="inline-flex h-14 items-center justify-center rounded-2xl bg-cyberPurple px-6 text-sm font-black uppercase tracking-wide text-white transition hover:bg-cyberPurpleSoft">
              Discover scenes
            </Link>
          </div>
        </section>
        ...
        <div className="grid gap-6 xl:grid-cols-[0.95fr_0.85fr]">
          <section className="rounded-4xl border border-white/10 bg-cyberPanel/95 p-6 shadow-glow">
            ...
            <div className="mt-6 space-y-4">
              {LEADERBOARD_ITEMS.map((item) => (
                <div key={item.rank} className="rounded-3xl border border-white/10 bg-white/5 p-4">
                  <div className="flex items-center justify-between gap-4">
                    <div>
          ...
          <section className="rounded-4xl border border-white/10 bg-cyberPanel/95 p-6 shadow-glow">
            ...
            <div className="mt-6 grid gap-4">
              {MERCH_ITEMS.slice(0, 4).map((item) => (
